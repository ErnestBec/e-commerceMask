...
if (empty($cantidad)) {
    header('location:../includes/detalleArticulo.php?error_cantidad=Favor de ingresar una cantidad valida');
} elseif ($cantidad <= 0) {
    header('location:../includes/detalleArticulo.php?error_cantidad=Favor de ingresar una cantidad valida');
} elseif ($cantidad > $dataArt["cantidad"]) {
    header('location:../includes/detalleArticulo.php?error_cantidad= Solo puede comprar menos de ' . $dataArt["cantidad"] . "productos.");
} else {
