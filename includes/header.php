...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="d-lg-none">
                    ...
                    <svg class="me-3" width="54" height="40" viewBox="0 0 54 40" fill="none"
                        xmlns="http://www.w3.org/2000/svg" type="button" data-bs-toggle="modal"
                    ...
                    <svg width="54" height="40" viewBox="0 0 56 49" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./resources/pages/misPedidos.php">Mis Compras</a>
                        </li>
                        <li class="nav-item">
    ...
    <?php include 'modalResgistrarUsuario.php'; ?>
