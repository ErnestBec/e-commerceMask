<footer
        ...
        <div class="d-flex justify-content-evenly mt-3">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_114_851)">
                    <path
                        d="M40 20.1226C40 9.00756 31.045 -0.00244141 20 -0.00244141C8.95 5.85939e-05 -0.00500488 9.00756 -0.00500488 20.1251C-0.00500488 30.1676 7.31 38.4926 16.87 40.0026V25.9401H11.795V20.1251H16.875V15.6876C16.875 10.6451 19.8625 7.86006 24.43 7.86006C26.62 7.86006 28.9075 8.25256 28.9075 8.25256V13.2026H26.385C23.9025 13.2026 23.1275 14.7551 23.1275 16.3476V20.1226H28.6725L27.7875 25.9376H23.125V40.0001C32.685 38.4901 40 30.1651 40 20.1226Z"
                        fill="white" />
                </g>
                <defs>
    ...
    <div class="d-flex justify-content-evenly container-fluid">
        ...
        <div class="d-flex flex-column mt-3 mt-sm-3 mt-lg-0">
            <span class="text-light d-flex justify-content-center ">Llamanos sin costo al:
            </span>
            <a href="tel:+521234567890" class="text-light d-flex justify-content-center ">123-456-7890</a>
        </div>
        <div class="d-flex flex-column mt-3 mt-sm-3 mt-lg-0">
            <span class="text-light d-flex justify-content-center ">Correo electronico:
            </span>
            <a href="mailto:mascaras@gmail.com" class="text-light d-flex justify-content-center ">
                mascaras@gmail.com</a>
        </div>
    </div>
